...
void ODBasePipeline::createShaderModule(const std::vector<char> &code,
...
ODGraphicsPipeline::ODGraphicsPipeline(
    ODDevice &device, const std::string &vertexShaderPath,
    const std::string &fragmentShaderPath,
    const ODGraphicsPipelineConfigInfo &configInfo)
    : ODBasePipeline(device) {
...
void ODGraphicsPipeline::createGraphicsPipeline(
...
void ODGraphicsPipeline::defaultPipelineConfigInfo(
    ODDevice &device, ODGraphicsPipelineConfigInfo &configInfo) {
  ...
  // color blending (how to combine colors in frame buffer)
  ...
  // dynamic states (dynamic viewport and scissor)
  ...
  configInfo.bindingDescriptions = ODModel::Vertex::getBindingDescriptions();
  configInfo.attributeDescriptions =
      ODModel::Vertex::getAttributeDescriptions();
}

void ODGraphicsPipeline::enableAlphaBlending(
    ODGraphicsPipelineConfigInfo &configInfo) {
...
ODComputePipeline::ODComputePipeline(
    ODDevice &device, const std::string &computeShaderPath,
...
void ODComputePipeline::createComputePipeline(
