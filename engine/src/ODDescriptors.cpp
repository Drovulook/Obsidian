...
namespace ODEngine {
    ...
    ODDescriptorSetLayout::Builder &ODDescriptorSetLayout::Builder::addBinding(
        uint32_t binding,
    ...
    std::unique_ptr<ODDescriptorSetLayout> ODDescriptorSetLayout::Builder::build() const {
        return std::make_unique<ODDescriptorSetLayout>(device, bindings);
    }
    ...
    ODDescriptorPool::ODDescriptorPool(
        ODDevice &device,
        uint32_t maxSets,
    ...
    bool ODDescriptorPool::allocateDescriptorSet(
    ...
    void ODDescriptorPool::freeDescriptors(std::vector<VkDescriptorSet> &descriptors) const {
    ...
    void ODDescriptorPool::resetPool() {
    ...
    ODDescriptorWriter::ODDescriptorWriter(ODDescriptorSetLayout &setLayout, ODDescriptorPool &pool)
    ...
    void ODDescriptorWriter::overwrite(VkDescriptorSet &set) {
